        ...
        <div className="triangularBackdrop">
            <Flex flexDirection="column" justifyContent="center" alignItems="center">
                ...
                <div style={{ display: "flex", flexDirection: "row", gap: "4rem", marginTop: "4rem" }} >
                    <Box className="hoverable" width="16rem" height="16rem" boxShadow="dark-lg" bg="blue.50" borderRadius="1rem" display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap="2rem" onClick={goToAdmin} >
                    ...
                    <Box className="hoverable" width="16rem" height="16rem" boxShadow="dark-lg" bg="blue.50" borderRadius="1rem" display="flex" flexDirection="column" justifyContent="center" alignItems="center" onClick={goToEndUser}>
